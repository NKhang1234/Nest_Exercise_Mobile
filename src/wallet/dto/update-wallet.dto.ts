...
export class UpdateWalletDto {
  @ApiProperty({ description: 'The new unique name of the wallet', example: 'Cash Updated' })
  @IsString()
  @IsNotEmpty()
  name: string;

  @ApiProperty({ description: 'The new initial amount in the wallet', example: 600.0 })
  @IsNumber()
  @IsNotEmpty()
  initAmount: number;
